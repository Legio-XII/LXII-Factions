  class BNB_FA_LXII_Rifleman_PT: B_Soldier_F
  {
    ...
    linkedItems[]={"ItemMap","ItemCompass","ItemWatch","TFAR_anprc152","ItemGPS","dm_CadianArmourWhite","ic_PraetorianHelm"};
    respawnLinkedItems[]={"ItemMap","ItemCompass","ItemWatch","TFAR_anprc152","ItemGPS","dm_CadianArmourWhite","ic_PraetorianHelm"};
    backpack="BNB_FA_LXII_Rifleman_PT_pack";
  };

  class BNB_FA_LXII_Medic_PT: B_medic_F
  {
    faction="BNB_FA_LXII_Faction";
    editorSubcategory = "BNB_FA_LXII_PT";
    side=1;
    ...
    linkedItems[]={"ItemMap","ItemCompass","ItemWatch","TFAR_anprc152","ItemGPS","dm_CadianArmourWhite","ic_PraetorianHelm"};
    respawnLinkedItems[]={"ItemMap","ItemCompass","ItemWatch","TFAR_anprc152","ItemGPS","dm_CadianArmourWhite","ic_PraetorianHelm"};
    backpack="BNB_FA_LXII_Medic_PT_pack";
  };

  class BNB_FA_LXII_IC_PT: B_Soldier_SL_F
  {
    faction="BNB_FA_LXII_Faction";
    editorSubcategory = "BNB_FA_LXII_PT";
    side=1;
    ...
    magazines[]={"ic_hellgun_mag2","ic_hellgun_mag2","ic_hellgun_mag2"};
    respawnMagazines[]={"ic_hellgun_mag2","ic_hellgun_mag2","ic_hellgun_mag2"};
    linkedItems[]={"ItemMap","ItemCompass","ItemWatch","TFAR_anprc152","ItemGPS","dm_CadianArmourWhite","IC_scion_beret"};
    respawnLinkedItems[]={"ItemMap","ItemCompass","ItemWatch","TFAR_anprc152","ItemGPS","dm_CadianArmourWhite","IC_scion_beret"};
    backpack="BNB_FA_LXII_IC_PT_pack";
  };


  class BNB_FA_LXII_Rifleman_PT_pack: IC_CAD_kasr_pack_white
  {
    scope=2;
  ...
  class BNB_FA_LXII_Medic_PT_pack: IC_CAD_kasr_pack_white
  {
    scope=2;
    class TransportMagazines{};
    class TransportItems
  ...
  class BNB_FA_LXII_IC_PT_pack: IC_CAD_kasr_pack_white
  {
    scope=2;
    class TransportMagazines
    {
